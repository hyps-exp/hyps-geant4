...
#ifndef SKSVirtualPlaneSD_h
#define SKSVirtualPlaneSD_h 1
...
class SKSVirtualPlaneSD : public G4VSensitiveDetector
{
  public:
  
     SKSVirtualPlaneSD(G4String);
     ~SKSVirtualPlaneSD();
      ...
      void PrintAll();
  private:
      SKSVirtualPlaneHitsCollection*  CalCollection;      
