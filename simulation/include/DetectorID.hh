...
// T0
const int NumOfSegmentT0  = 1;

// SDC1
const int NumOfPlaneSDC1  = 4;

// SDC2
const int NumOfPlaneSDC2  = 6;

// SDC3
const int NumOfPlaneSDC3  = 5;

// SDC4
const int NumOfPlaneSDC4  = 5;
...
const int NumOfSegmentTOF = 48; // for HYPS
...
// eVeto
const int NumOfSegmenteVeto  = 1;

//Counter
const int NumOfCounter = 5; // FTOF, T0, PIV, AC, BGO_VP
